...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // ePAYERCOIN: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "ePAYERCOIN Signed Message:\n";
...
static const int64 nTargetTimespan = 3 * 60 * 60; // every 3 hours
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock) {
		static const int64 BlocksTargetSpacing	= 42; // 42 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ePAYERCOIN miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ePAYERCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Mon, 09 Feb 2015 16:40:07 GMT";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1423500018;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 4270995;

        if (fTestNet)
        {
            block.nTime    = 1423500015;
            block.nNonce   = 4270995;
        }
 ...
 //// debug print
        ...
        assert(block.hashMerkleRoot == uint256("0x6ca632b6d279f7d71249ea4876fb72344fe3c7dd682a711176bf24e283e50793"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // ePAYERCOINd: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
